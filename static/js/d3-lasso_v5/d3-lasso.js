    ...
    function lasso() {
        ...
        function lasso(_this) {
            ...
            function dragmove() {
                ...
                if (tpath==="") {
                    tpath = tpath + "M " + tx + " " + ty;
                    lasso_path = lasso_path + "M " + curr_xScale.invert(tx) + " " + curr_yScale.invert(ty);
                    origin = [x,y];
                    torigin = [tx,ty];
                    // Draw origin node
                    origin_node
                    ...
                    tpath = tpath + " L " + tx + " " + ty;
                    lasso_path = lasso_path + "L" + curr_xScale.invert(tx) + " " + curr_yScale.invert(ty);
                }
                ...
                var close_draw_path1 = "M " + curr_xScale.invert(tx) + " " + curr_yScale.invert(ty) + " L " + torigin[0] + " " + torigin[1];
