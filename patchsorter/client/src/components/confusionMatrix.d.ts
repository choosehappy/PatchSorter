...
export default function ConfusionMatrix({ confusionData, selectedCells, colorBy, classLabels, classColors, onCellClick, onHeaderClick, }: ConfusionMatrixProps): import("react/jsx-runtime").JSX.Element;
export {};
