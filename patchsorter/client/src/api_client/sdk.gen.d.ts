 ...
 */
export declare const samplePatchesByBboxProjectsProjectIdSampleByBboxPatchesGet: <ThrowOnError extends boolean = false>(options: Options<SamplePatchesByBboxProjectsProjectIdSampleByBboxPatchesGetData, ThrowOnError>) => import("./client").RequestResult<SamplePatchesByBboxProjectsProjectIdSampleByBboxPatchesGetResponses, SamplePatchesByBboxProjectsProjectIdSampleByBboxPatchesGetErrors, ThrowOnError, "fields">;
/**
 * Sample Patches By Bbox
 */
export declare const samplePatchesByBboxProjectsProjectIdSampleByBboxPatchesPost: <ThrowOnError extends boolean = false>(options: Options<SamplePatchesByBboxProjectsProjectIdSampleByBboxPatchesPostData, ThrowOnError>) => import("./client").RequestResult<SamplePatchesByBboxProjectsProjectIdSampleByBboxPatchesPostResponses, SamplePatchesByBboxProjectsProjectIdSampleByBboxPatchesPostErrors, ThrowOnError, "fields">;
/**
 * Sample Patches By Point
 */
export declare const samplePatchesByPointProjectsProjectIdSampleByPointPatchesGet: <ThrowOnError extends boolean = false>(options: Options<SamplePatchesByPointProjectsProjectIdSampleByPointPatchesGetData, ThrowOnError>) => import("./client").RequestResult<SamplePatchesByPointProjectsProjectIdSampleByPointPatchesGetResponses, SamplePatchesByPointProjectsProjectIdSampleByPointPatchesGetErrors, ThrowOnError, "fields">;
