...
if __name__ == '__main__':
    try:
        ...
        #  './projects/p/patches_p.pytable', '-b1024', '-p32', '-r-1', '2', '--maskpatches'])
        ...
        model_name = f"{args.outdir}/best_model_simclr_C{args.codesize}_N{args.nclasses}_P{args.patchsize}.pth"
